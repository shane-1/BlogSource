...
<h2 id="nosql概述" tabindex="-1"><a class="header-anchor" href="#nosql概述" aria-hidden="true">#</a> NoSQL概述</h2>
<h3 id="为什么要用nosql" tabindex="-1"><a class="header-anchor" href="#为什么要用nosql" aria-hidden="true">#</a> 为什么要用NoSQL</h3>
<blockquote>
<p>大数据时代,传统SQL不满足需求</p>
</blockquote>
<h4 id="单机mysql的年代" tabindex="-1"><a class="header-anchor" href="#单机mysql的年代" aria-hidden="true">#</a> 单机MySQL的年代</h4>
<p><img src="/images/2020-11-16-09-47-24.png" alt=""></p>
<p><strong>90s:</strong></p>
<ul>
<li>一个基本的网站的访问量一般不会太大,单机够用</li>
<li>静态网页\服务器压力小</li>
</ul>
<p><strong>网站瓶颈:</strong></p>
<ul>
<li>
<p>数据量太大,一个机器放不下!</p>
</li>
<li>
<p>数据的索引(B+Tree),一个机器内存放不下</p>
</li>
<li>
<p>访问量(读写混合),一个服务器也放不下</p>
<blockquote>
<p>出现以上任一情况,都需要升级</p>
</blockquote>
</li>
</ul>
<h4 id="memcached-缓存-mysql-垂直拆分-读写分离" tabindex="-1"><a class="header-anchor" href="#memcached-缓存-mysql-垂直拆分-读写分离" aria-hidden="true">#</a> Memcached(缓存) + MySQL + 垂直拆分(读写分离)</h4>
<p>网站80%的情况都是在读,每次都要去查询数据库的话就十分的麻烦!所以说我们希望减轻数据的压力,我们可以使用缓存来保证效率!</p>
<p><strong>发展过程:</strong></p>
<p>优化数据结构和索引	--&gt;	文件缓存(IO)	--&gt;	Memcached</p>
<p><img src="/images/2020-11-16-09-59-59.png" alt=""></p>
<h4 id="分库分表-水平拆分-mysql集群" tabindex="-1"><a class="header-anchor" href="#分库分表-水平拆分-mysql集群" aria-hidden="true">#</a> 分库分表  + 水平拆分 + MySQL集群</h4>
<p>技术和业务发展的同时,对人的要求越来越高!</p>
<p><strong><u>本质:数据库(读\写)</u></strong></p>
<p>早年MyISAM: 表锁,十分影响效率!高并发下就会出现严重的锁问题</p>
<p>转战Innodb:行锁</p>
<p>慢慢的就开始使用分库分表来解决写的压力!MySQL在那个年代推出了<u>表分区</u>!这个并没有多少公司使用!</p>
<p>MySQL的集群,很好满足了那个年代的需求!</p>
<p><img src="/images/2020-11-16-10-05-59.png" alt=""></p>
<h4 id="当今" tabindex="-1"><a class="header-anchor" href="#当今" aria-hidden="true">#</a> 当今</h4>
<p>MySQL等关系型数据库就不够用了!数据量很多,变化很快~!</p>
<p>MySQL有点使用它来存储比较大的文件(图片\博客)!数据库表很大,效率就低了!如果有一种数据库来专门处理这种数据.</p>
<p>MySQL的压力就变得十分小(研究处理这些问题!)大数据的IO压力下,表集合没法更大!</p>
<p><img src="/images/2020-11-16-10-20-13.png" alt=""></p>
<h4 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h4>
<ul>
<li>用户的个人信息,社交网络,地理位置.用户自己产生的数据,用户日志等爆发式增长!</li>
<li>这时候我们就需要使用NoSQL数据库,NoSQL能很好处理以上情况!</li>
</ul>
<h3 id="什么是nosql" tabindex="-1"><a class="header-anchor" href="#什么是nosql" aria-hidden="true">#</a> 什么是NoSQL</h3>
<blockquote>
<p>NoSQL = Not Only SQL</p>
</blockquote>
<p>关系型数据库: 表格, 行, 列 (OPI)</p>
<p>泛指非关系数据库的,随着web2.0互联网的诞生!传统的关系型数据库很难对付web2.0时代!尤其是超大规模的高并发的社区!暴露出很多难以克服的问题,NoSQL在当今大数据环境下发展得十分迅速,Redis是发展最快的,而且是我们当下必须要掌握的技术!</p>
<p>很多的数据类型用户的个人信息,社交网络,地理位置.这些数据类型的储存不需要一个固定的格式!不需要多月的操作就可以横向扩展的!Map&lt;String,Obeject&gt;使用键值对来控制的!</p>
...
<li>
<p>大数据量高性能(Redis一秒写8万次,读取11万,NoSQL的缓存记录级,是一种细粒度的缓存,性能会比较高!)</p>
</li>
<li>
<p>数据类型是多样性的!(不需要事先设计数据库!随取随用!如果是数据量十分大的表,很多人就无法设计了!)</p>
</li>
<li>
<p>传统RDBMS和NoSQL</p>
...
<h3 id="了解-3v-3高" tabindex="-1"><a class="header-anchor" href="#了解-3v-3高" aria-hidden="true">#</a> 了解: 3V+3高</h3>
...
<ol>
<li>高并发</li>
<li>高可拓(随时水平拆分,弹性伸缩)</li>
<li>高性能</li>
</ol>
<p>真正的公司实践: NoSQL + RDBMS一起使用才是最强的</p>
<h2 id="阿里巴巴的架构演进" tabindex="-1"><a class="header-anchor" href="#阿里巴巴的架构演进" aria-hidden="true">#</a> 阿里巴巴的架构演进</h2>
<p><strong>敏捷开发 + 极限编程</strong></p>
<p><img src="/images/2020-11-16-12-10-45.png" alt="">
<img src="/images/2020-11-16-12-11-33.png" alt=""></p>
<p>没有什么是加一层解决不了了</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code># 1. 商品的基本信息
名称、价格、商家信息
...
# 6. 商品的交易\外部的制服接口
- 三方应用
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>一个简单的网页背后的技术一定不简单</p>
<h3 id="大型互联网的问题" tabindex="-1"><a class="header-anchor" href="#大型互联网的问题" aria-hidden="true">#</a> 大型互联网的问题:</h3>
<ul>
<li>数据类型太多了</li>
<li>数据源繁多,经常重构</li>
<li>数据要改造,大面积改造</li>
...
<p><img src="/images/2020-11-16-13-28-19.png" alt=""></p>
<p><img src="/images/2020-11-16-13-29-42.png" alt=""></p>
<h2 id="nosql的四大分类" tabindex="-1"><a class="header-anchor" href="#nosql的四大分类" aria-hidden="true">#</a> NoSQL的四大分类</h2>
<h3 id="kv键值对" tabindex="-1"><a class="header-anchor" href="#kv键值对" aria-hidden="true">#</a> KV键值对:</h3>
<ul>
<li>新浪: Redis</li>
<li>美图: Redis + Tair</li>
<li>阿里\百度: Redis + memecache</li>
</ul>
<h3 id="文档型数据库-bson格式和json一样" tabindex="-1"><a class="header-anchor" href="#文档型数据库-bson格式和json一样" aria-hidden="true">#</a> 文档型数据库(bson格式和json一样):</h3>
<ul>
<li>MongoDB(一般必须要掌握)
<ul>
<li>MongoDB是一个基于分布式文件储存的数据库,C++编写,主要用来处理大量的文档!</li>
<li>MongoDB是一样介于关系型数据库和非关系型数据库的中间产品!MongoDB是非关系型数据库功能最丰富,最像关系型数据库的!</li>
</ul>
</li>
<li>ConthDB</li>
</ul>
<h3 id="列存储数据库" tabindex="-1"><a class="header-anchor" href="#列存储数据库" aria-hidden="true">#</a> 列存储数据库</h3>
<ul>
<li>HBase</li>
<li>分布式文件系统</li>
</ul>
<h3 id="图关系数据库" tabindex="-1"><a class="header-anchor" href="#图关系数据库" aria-hidden="true">#</a> 图关系数据库</h3>
<p><img src="/images/2020-11-16-13-36-59.png" alt=""></p>
<ul>
<li>它不是存图形的,放的是关系. 比如:朋友圈社交网络,广告推荐!</li>
<li>Neo4j, InfoGrid;</li>
</ul>
<h3 id="对比" tabindex="-1"><a class="header-anchor" href="#对比" aria-hidden="true">#</a> 对比</h3>
<p><img src="/images/2020-11-16-13-40-46.png" alt=""></p>
<h2 id="redis入门" tabindex="-1"><a class="header-anchor" href="#redis入门" aria-hidden="true">#</a> Redis入门</h2>
<h3 id="概述" tabindex="-1"><a class="header-anchor" href="#概述" aria-hidden="true">#</a> 概述</h3>
<blockquote>
<p>Redis (Remote Dictionary Server), 远程字典服务</p>
</blockquote>
<p>是一个开源的使用ANSI C语言编写、支持网络、可基于内存亦可持久化的日志型、Key-Value数据库,并提供多种语言的APl。是当下最热门的NoSQL技术之一!也被人们称为结构化数据库!</p>
<h3 id="功能" tabindex="-1"><a class="header-anchor" href="#功能" aria-hidden="true">#</a> 功能</h3>
<ol>
<li>内存存储, 持久化, 内存中是断电即失, 所以持久化**(rdb\aof)**很重要</li>
<li>效率高, 可以用于高速缓存</li>
<li>发布订阅系统</li>
<li>地图信息分析</li>
<li>计时器, 计数器(浏览量)</li>
...
<h3 id="相关资源" tabindex="-1"><a class="header-anchor" href="#相关资源" aria-hidden="true">#</a> 相关资源</h3>
<ol>
<li>官网: https://redis.io/</li>
<li>中文官网: http://www.redis.cn/</li>
<li>下载地址: 通过官网下载</li>
</ol>
<blockquote>
<p>注意: Windows版本在GitHub下载</p>
<p><strong>推荐在Linux服务器搭建</strong></p>
</blockquote>
<h2 id="windows安装" tabindex="-1"><a class="header-anchor" href="#windows安装" aria-hidden="true">#</a> Windows安装</h2>
<ol>
<li>
<p>下载安装包: https://github.com/dmajkic/redis/releases</p>
</li>
<li>
<p>下载完毕得到压缩包:</p>
</li>
</ol>
<p><img src="/images/2020-11-16-13-56-18.png" alt=""></p>
<ol start="3">
<li>
<p>解压到对应文件夹</p>
</li>
<li>
<p>开启Redis,双击运行服务即可</p>
</li>
</ol>
<p><img src="/images/2020-11-16-13-57-57.png" alt=""></p>
<ol start="5">
<li>使用客户端来连接Redis</li>
</ol>
<p><img src="/images/2020-11-16-14-00-04.png" alt=""></p>
<blockquote>
<p>默认端口6379</p>
</blockquote>
...
<li>
<p>解压redis的安装包(推荐/opt目录)</p>
</li>
</ol>
<p><img src="/images/2020-11-16-14-30-56.png" alt=""></p>
<ol start="3">
<li>进入解压后的文件,可以看到redis的配置文件</li>
</ol>
<p><img src="/images/2020-11-16-14-35-36.png" alt=""></p>
<ol start="4">
<li>
<p>基本环境准备</p>
<ol>
...
<li>make</li>
<li>make install
<img src="/images/2020-11-16-14-53-55.png" alt="">
<img src="/images/2020-11-16-14-54-38.png" alt=""></li>
</ol>
</li>
<li>
<p>redis的默认安装路径<code v-pre>/usr/local/bin</code></p>
</li>
</ol>
<p><img src="/images/2020-11-16-14-46-02.png" alt=""></p>
<ol start="6">
<li>将redis的配置文件复制到当前目录</li>
</ol>
<p><img src="/images/2020-11-16-14-57-27.png" alt=""></p>
<ol start="7">
<li>redis默认不是后台启动,修改配置文件</li>
</ol>
<p><img src="/images/2020-11-16-14-58-31.png" alt=""></p>
<ol start="8">
<li>启动redis服务<code v-pre>redis-server  dir/redis.cofig</code></li>
</ol>
<p><img src="/images/2020-11-16-14-59-47.png" alt=""></p>
<ol start="9">
<li>使用redis-cli进行连接测试<code v-pre>redis-cli -p 6379</code></li>
</ol>
<p><img src="/images/2020-11-16-15-01-33.png" alt=""></p>
<ol start="10">
<li>查看redis的进程是否开启<code v-pre>ps -ef|grep redis</code></li>
</ol>
<p><img src="/images/2020-11-16-15-02-25.png" alt=""></p>
<ol start="11">
<li>关闭redis服务<code v-pre>shut down</code></li>
</ol>
<p><img src="/images/2020-11-16-15-03-16.png" alt=""></p>
<h2 id="测试性能" tabindex="-1"><a class="header-anchor" href="#测试性能" aria-hidden="true">#</a> 测试性能</h2>
<p><u>redis-benchmark</u> 是一个压力测试工具!</p>
<p>官方自带的性能测试工具</p>
<h3 id="redis-benchmark命令参数" tabindex="-1"><a class="header-anchor" href="#redis-benchmark命令参数" aria-hidden="true">#</a> redis-benchmark命令参数</h3>
<p><img src="/images/2020-11-16-15-16-03.png" alt=""></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="/images/2020-11-16-15-27-49.png" alt=""></p>
<p><img src="/images/2020-11-16-15-29-39.png" alt=""></p>
<h2 id="基础知识" tabindex="-1"><a class="header-anchor" href="#基础知识" aria-hidden="true">#</a> 基础知识</h2>
<p>redis默认有16个数据库</p>
<p><img src="/images/2020-11-16-15-31-27.png" alt=""></p>
<p>默认使用的是第0个数据库</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="/images/2020-11-16-15-35-28.png" alt=""></p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:6379<span class="token punctuation">[</span><span class="token number">3</span><span class="token punctuation">]</span><span class="token operator">></span> keys* <span class="token comment">#查看所有的key</span>
<span class="token number">1</span><span class="token punctuation">)</span> <span class="token string">"name"</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>清除当前数据库<code v-pre>flush</code></p>
<p>清除所有数据库<code v-pre>FLUSHALL</code></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>思考: 为什么redis默认端口是6379!</p>
<blockquote>
<p>追星(MySQL3306女儿名)</p>
</blockquote>
<h3 id="redis是单线程的" tabindex="-1"><a class="header-anchor" href="#redis是单线程的" aria-hidden="true">#</a> Redis是单线程的</h3>
<p>Redis是很快的,基于内存操作,CPU不是Redis的性能瓶颈,而是根据极其的内存和网络带宽.既然可以使用单线程来实现,就使用单线程了!</p>
<p>Redis是C语言写的,官方提供数据为100000+的QPS,完全不比同样是使用key-value的Memecache差!</p>
<p><strong>Redis为什么单线程还快?</strong></p>
<ol>
<li>
...
<p>核心:redis是将所有的数据全部放在内存中的,所以谁使用单线程去操作效率就是最高的,多线程(<u>存在CPU上下文切换的耗时操作</u>),<strong>对于内存系统来说,如果没有上下文切换效率就是最高的!<strong>多次读写都是在一个CPU上的</strong>,在内存情况下,这个就是最佳的方案!</strong></p>
<h2 id="五大数据类型" tabindex="-1"><a class="header-anchor" href="#五大数据类型" aria-hidden="true">#</a> 五大数据类型</h2>
<p>Redis是一个开源(BSD许可)的,内存中的数据结构存储系统,它可以用作<strong>数据库、缓存和消息中间件MQ</strong>。它支持多种类型的
数据结构,如字符串( strings), 散列( hashes), 列表( lists), 集合(sets), 有序集合( sorted sets)与范围查询, bitmaps, hyperloglogs和地理空间( geospatial)索引半径查询。</p>
<p>Redis内置了复制( replication),LUA脚本(Luascripting), LRU驱动事件( LRU eviction), 事务( transactions)和不同级别的磁盘持久化( persistence),并通过Reds哨兵(Sentinel)和自动分区( Cluster)提供高可用性( high availability)。</p>
<h3 id="redis-key" tabindex="-1"><a class="header-anchor" href="#redis-key" aria-hidden="true">#</a> Redis-Key</h3>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> keys* <span class="token comment">#查看所有的key</span>
<span class="token punctuation">(</span>empty list or <span class="token builtin class-name">set</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a href="http://www.redis.cn/commands.html" target="_blank" rel="noopener noreferrer">官网命令查询地址<ExternalLinkIcon/></a></p>
<h3 id="string-字符串" tabindex="-1"><a class="header-anchor" href="#string-字符串" aria-hidden="true">#</a> String(字符串)</h3>
<p>90%的程序员只会使用的类型</p>
<h4 id="设置获取" tabindex="-1"><a class="header-anchor" href="#设置获取" aria-hidden="true">#</a> 设置获取</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> <span class="token builtin class-name">set</span> key v1 <span class="token comment">#设置值</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="自增减" tabindex="-1"><a class="header-anchor" href="#自增减" aria-hidden="true">#</a> 自增减</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="字符串范围" tabindex="-1"><a class="header-anchor" href="#字符串范围" aria-hidden="true">#</a> 字符串范围</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> <span class="token builtin class-name">set</span> key <span class="token string">"hello,world!!!"</span>
OK
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="替换" tabindex="-1"><a class="header-anchor" href="#替换" aria-hidden="true">#</a> 替换</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> <span class="token builtin class-name">set</span> key abcdefg
OK
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="过期时间设置" tabindex="-1"><a class="header-anchor" href="#过期时间设置" aria-hidden="true">#</a> 过期时间设置</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># setex (set with expire) #设置过期时间</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="批量操作" tabindex="-1"><a class="header-anchor" href="#批量操作" aria-hidden="true">#</a> 批量操作</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="对象" tabindex="-1"><a class="header-anchor" href="#对象" aria-hidden="true">#</a> 对象</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token builtin class-name">set</span> user:1 <span class="token punctuation">{</span>name:shane, age:3<span class="token punctuation">}</span><span class="token comment"># 设置一个user:1对象值为json字符来保存一个对象</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="getset" tabindex="-1"><a class="header-anchor" href="#getset" aria-hidden="true">#</a> getset</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> getset bd redis <span class="token comment">#如果不存在值,则返回nil</span>
<span class="token punctuation">(</span>nil<span class="token punctuation">)</span>
...
<p>所有的list命令都是用l开头的</p>
<h4 id="lpush-rpush" tabindex="-1"><a class="header-anchor" href="#lpush-rpush" aria-hidden="true">#</a> LPUSH&amp;RPUSH</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> LPUSH list one <span class="token comment">#将一个或多个值插入列表的头部</span>
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">1</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="lpop-rpop" tabindex="-1"><a class="header-anchor" href="#lpop-rpop" aria-hidden="true">#</a> LPOP&amp;RPOP</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> LRANGE list <span class="token number">0</span> <span class="token parameter variable">-1</span> 
<span class="token number">1</span><span class="token punctuation">)</span> <span class="token string">"three"</span>
<span class="token number">2</span><span class="token punctuation">)</span> <span class="token string">"two"</span>
<span class="token number">3</span><span class="token punctuation">)</span> <span class="token string">"one"</span>
<span class="token number">4</span><span class="token punctuation">)</span> <span class="token string">"four"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="lindex" tabindex="-1"><a class="header-anchor" href="#lindex" aria-hidden="true">#</a> Lindex</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> LRANGE list <span class="token number">0</span> <span class="token parameter variable">-1</span>
<span class="token number">1</span><span class="token punctuation">)</span> <span class="token string">"two"</span>
<span class="token number">2</span><span class="token punctuation">)</span> <span class="token string">"one"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="llen" tabindex="-1"><a class="header-anchor" href="#llen" aria-hidden="true">#</a> Llen</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> LPUSH list one 
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">1</span>
<span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> LPUSH list two
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">2</span>
<span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> LPUSH list three
...
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">3</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="lrem" tabindex="-1"><a class="header-anchor" href="#lrem" aria-hidden="true">#</a> Lrem</h4>
<blockquote>
<p>移除指定的值</p>
</blockquote>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> LRANGE list <span class="token number">0</span> <span class="token parameter variable">-1</span>
...
<span class="token number">2</span><span class="token punctuation">)</span> <span class="token string">"three"</span>
<span class="token number">3</span><span class="token punctuation">)</span> <span class="token string">"two"</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="ltrim" tabindex="-1"><a class="header-anchor" href="#ltrim" aria-hidden="true">#</a> ltrim</h4>
<p>修建/截断</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> Rpush mylist <span class="token string">"hello"</span>
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">1</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="rpoolpush" tabindex="-1"><a class="header-anchor" href="#rpoolpush" aria-hidden="true">#</a> rpoolpush</h4>
<blockquote>
<p>移除带列表最后一个元素,并将它移动到新的列表</p>
</blockquote>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> Rpush mylist <span class="token string">"hello"</span>
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">1</span>
<span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> Rpush mylist <span class="token string">"hello1"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="lset" tabindex="-1"><a class="header-anchor" href="#lset" aria-hidden="true">#</a> Lset</h4>
<blockquote>
<p>列表必须存在,否则报错<code v-pre>(error) ERR no such key</code></p>
<p>列表的index必须存在,否则报错<code v-pre>(error) ERR index out of range</code></p>
</blockquote>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> lpush list value
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">1</span>
<span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> lrange list <span class="token number">0</span> <span class="token parameter variable">-1</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="linsert" tabindex="-1"><a class="header-anchor" href="#linsert" aria-hidden="true">#</a> linsert</h4>
<blockquote>
<p>将某个值插入到特定值的前面/后面</p>
</blockquote>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> Rpush mylist <span class="token string">"hello"</span>
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">1</span>
<span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> Rpush mylist <span class="token string">"hello1"</span>
...
<ul>
<li>list实际为一个链表,before Node after, left, right 都可以插入值</li>
<li>如果key不存在,创建新的脸</li>
<li>如果key存在,新增内容</li>
...
<p>set中的值是不能重复的</p>
<h4 id="sadd-smembers" tabindex="-1"><a class="header-anchor" href="#sadd-smembers" aria-hidden="true">#</a> sadd&amp;Smembers</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> sadd myset <span class="token string">"hello"</span> <span class="token comment">#添加值</span>
...
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">0</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="scard" tabindex="-1"><a class="header-anchor" href="#scard" aria-hidden="true">#</a> Scard</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> scard myset <span class="token comment">#获取set集合中的内容元素个数</span>
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">3</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="srem" tabindex="-1"><a class="header-anchor" href="#srem" aria-hidden="true">#</a> SRem</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> srem myset he1lo <span class="token comment">#移除set集合中的指定元素</span>
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">1</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="srandmember" tabindex="-1"><a class="header-anchor" href="#srandmember" aria-hidden="true">#</a> Srandmember</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> SRANDMEMBER myset
<span class="token string">"shane"</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="spop" tabindex="-1"><a class="header-anchor" href="#spop" aria-hidden="true">#</a> Spop</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1: <span class="token number">637</span><span class="token operator"><span class="token file-descriptor important">9</span>></span> SMEMBERS myset
<span class="token number">1</span><span class="token punctuation">)</span> <span class="token string">"shane"</span>
<span class="token number">2</span><span class="token punctuation">)</span> <span class="token string">"jack"</span>
...
<span class="token number">1</span><span class="token punctuation">)</span> <span class="token string">"shane"</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="smove" tabindex="-1"><a class="header-anchor" href="#smove" aria-hidden="true">#</a> Smove</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1: <span class="token number">637</span><span class="token operator"><span class="token file-descriptor important">9</span>></span> sadd myset hello
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">1</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="数字集合类" tabindex="-1"><a class="header-anchor" href="#数字集合类" aria-hidden="true">#</a> 数字集合类:</h4>
<ul>
<li>差集</li>
<li>交集</li>
<li>并集</li>
</ul>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.6.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> sadd key1 a
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">1</span> 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>微博,A用户将所有关注的人放在一个set集合中!将他的粉丝也放在一个集合中!</p>
<p>共同关注, 共同爱好, 二度好友, 推荐好友!(六度分割理论)</p>
<h3 id="hash-哈希" tabindex="-1"><a class="header-anchor" href="#hash-哈希" aria-hidden="true">#</a> Hash(哈希)</h3>
<p>Map集合, key-map! 时这个值是一个map集合!本质和string类型没有太大的区别,还是一个简单的key-value!</p>
<h5 id="get-set" tabindex="-1"><a class="header-anchor" href="#get-set" aria-hidden="true">#</a> get&amp;set</h5>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> hset myhash fieldl shane <span class="token comment">#set一个key-vlaue</span>
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">1</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="hdel" tabindex="-1"><a class="header-anchor" href="#hdel" aria-hidden="true">#</a> hdel</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> hdel myhash field1 <span class="token comment">#删除hash指定key字段!对应的value值也就消失了!</span>
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">1</span>
...
<span class="token number">2</span><span class="token punctuation">)</span> <span class="token string">"world"</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="hlen" tabindex="-1"><a class="header-anchor" href="#hlen" aria-hidden="true">#</a> hlen</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> hmset myhash fieldl hello field2 world
OK
<span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> HGETALL myhash
<span class="token number">1</span><span class="token punctuation">)</span> <span class="token string">"field2"</span>
<span class="token number">2</span><span class="token punctuation">)</span> <span class="token string">"world"</span>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0,1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> HEXISTS myhash field1<span class="token comment">#判断hash中指定字段是否存在</span>
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">1</span>
...
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">0</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="hkeys-hvals" tabindex="-1"><a class="header-anchor" href="#hkeys-hvals" aria-hidden="true">#</a> hkeys&amp;hvals</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment">#只获得所有 Field</span>
...
<span class="token number">1</span><span class="token punctuation">)</span> <span class="token string">"world"</span>
<span class="token number">2</span><span class="token punctuation">)</span> <span class="token string">"he11o"</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="incr-decr" tabindex="-1"><a class="header-anchor" href="#incr-decr" aria-hidden="true">#</a> incr&amp;decr</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> hset myhash field3 <span class="token number">5</span> <span class="token comment">#指定增量!</span>
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">1</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>hash变更的数据 user name age,有其是用户的信息之类的,经常变动的信息! hash更适合于对象的存储,string更加适合字符串的存储</p>
<h3 id="zset-有序集合" tabindex="-1"><a class="header-anchor" href="#zset-有序集合" aria-hidden="true">#</a> Zset(有序集合)</h3>
<p>在set的基础上, 增加了一个值,</p>
<p><code v-pre>set k1 v1</code>   	<code v-pre>zset k1 score1 v1</code></p>
<h4 id="zadd" tabindex="-1"><a class="header-anchor" href="#zadd" aria-hidden="true">#</a> zadd</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:6379 <span class="token operator">></span> zadd myset 1one <span class="token comment">#添加一个值</span>
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">1</span>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1: <span class="token number">637</span><span class="token operator"><span class="token file-descriptor important">9</span>></span> zadd salary <span class="token number">2500</span> xiaohong
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="zrem" tabindex="-1"><a class="header-anchor" href="#zrem" aria-hidden="true">#</a> zrem</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment">#移除rem中的元素</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="zcard" tabindex="-1"><a class="header-anchor" href="#zcard" aria-hidden="true">#</a> zcard</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> zcard salary <span class="token comment"># 获取有序集合中的个数</span>
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">2</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="zcount" tabindex="-1"><a class="header-anchor" href="#zcount" aria-hidden="true">#</a> zcount</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> zadd myset <span class="token number">1</span> hello
...
<span class="token punctuation">(</span>integer<span class="token punctuation">)</span> <span class="token number">2</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>案例思路: set排序 存储班级成绩表 工资表排序!</p>
<p>普通消息(1) ,重要消息(2),带权重进行判断!</p>
<p>排行榜应用实现,取Top N测试</p>
<h2 id="三种特殊数据类型" tabindex="-1"><a class="header-anchor" href="#三种特殊数据类型" aria-hidden="true">#</a> 三种特殊数据类型</h2>
...
<p>可以查询一些测试数据:http://www.jsons.cn/lngcodeinfo/0706D99C19A781A3/</p>
<p>使用经纬度定位地理坐标并用一个有序集合zset保存，所以zset命令也可以使用</p>
<ul>
<li>
<p><code v-pre>geoadd key longitud(经度) latitude(纬度) member [..]</code> 将具体经纬度的坐标存入一个有序集合</p>
<blockquote>
<p>规则:两极无法直接添加,我们一般会下载城市数据,或者通过java程序一次性导入!</p>
<p>参数key 值(经度. 纬度. 名称)</p>
</blockquote>
</li>
<li>
<p><code v-pre>geopos key member [member..]</code> 获取集合中的一个/多个成员坐标</p>
</li>
<li>
<p><code v-pre>geodist key member1 member2 [unit]</code> 返回两个给定位置之间的距离。默认以米作为单位。[unit]中可以使用不同的单位</p>
</li>
<li>
<p><code v-pre>georadius key longitude latitude radius m|km|mi|ft [WITHCOORD][WITHDIST] [WITHHASH] [COUNT count]</code> 以给定的经纬度为中心， 返回集合包含的位置元素当中， 与中心的距离不超过给定最大距离的所有位置元素。</p>
</li>
<li>
<p><code v-pre>GEORADIUSBYMEMBER key member radius...</code> 功能与GEORADIUS相同，只是中心位置不是具体的经纬度，而是使用结合中<strong>已有的成员作为中心点</strong>。</p>
</li>
<li>
<p><code v-pre>geohash key member1 [member2..]</code> 返回一个或多个位置元素的Geohash表示。使用Geohash位置52点整数编码。</p>
</li>
</ul>
<h4 id="有效经纬度" tabindex="-1"><a class="header-anchor" href="#有效经纬度" aria-hidden="true">#</a> 有效经纬度</h4>
<ul>
...
<p>mi 表示单位为英里。</p>
<p>ft 表示单位为英尺。</p>
<h4 id="关于georadius的参数" tabindex="-1"><a class="header-anchor" href="#关于georadius的参数" aria-hidden="true">#</a> 关于GEORADIUS的参数</h4>
<p>通过georadius就可以完成 附近的人功能</p>
<ul>
<li>
<p>withcoord:带上坐标</p>
</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="georadiusbymember" tabindex="-1"><a class="header-anchor" href="#georadiusbymember" aria-hidden="true">#</a> GEORADIUSBYMEMBER</h4>
<p>通过指定元素找出周围的元素</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>找出位于指定元素周围的其他元素
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="geohash" tabindex="-1"><a class="header-anchor" href="#geohash" aria-hidden="true">#</a> GEOHASH</h4>
<p>返回11个字符的Geohash字符串</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment">#将二维的经纬度转换为一维的字符串,如果两个字符串越接近,那么则距离越近!</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="hyperloglog-基数统计" tabindex="-1"><a class="header-anchor" href="#hyperloglog-基数统计" aria-hidden="true">#</a> Hyperloglog(基数统计)</h3>
<blockquote>
<p>Redis 2.8.9+</p>
</blockquote>
...
<p>因为 HyperLogLog 只会根据输入元素来计算基数，而不会储存输入元素本身，所以 HyperLogLog 不能像集合那样，返回输入的各个元素。<u>Hyperloglog会有0.81%的错误率,传统UV任务,可以忽略</u></p>
<p>其底层使用string数据类型。</p>
<h4 id="什么是基数" tabindex="-1"><a class="header-anchor" href="#什么是基数" aria-hidden="true">#</a> 什么是基数？</h4>
<p>数据集中不重复的元素的个数。</p>
<h4 id="应用场景" tabindex="-1"><a class="header-anchor" href="#应用场景" aria-hidden="true">#</a> 应用场景：</h4>
<p>网页的访问量（UV）：一个用户多次访问，也只能算作一个人。</p>
<p>传统实现，存储用户的id,然后每次进行比较。<strong>当用户变多之后这种方式及其浪费空间，而我们的目的只是计数，Hyperloglog就能帮助我们利用最小的空间完成。</strong></p>
<ul>
<li><code v-pre>PFADD key element1 [elememt2..]</code> 添加指定元素到 HyperLogLog中</li>
<li><code v-pre>PFCOUNT key [key]</code> 返回给定 HyperLogLog 的基数估算值。</li>
<li><code v-pre>PFMERGE destkey sourcekey [sourcekey..]</code> 将多个 HyperLogLog 合并为一个 HyperLogLog</li>
</ul>
...
<p>签到统计、状态统计</p>
<ul>
<li><code v-pre>setbit key offset value</code> 为指定key的offset位设置值</li>
<li><code v-pre>getbit key offset</code> 获取offset位的值</li>
<li><code v-pre>bitcount key [start end]</code> 统计字符串被设置为1的bit数，也可以指定统计范围按字节</li>
<li><code v-pre>bitop operration destkey key[key..]</code> 对一个或多个保存二进制位的字符串 key 进行位元操作，并将结果保存到 destkey 上。</li>
<li><code v-pre>BITPOS key bit [start] [end]</code> 返回字符串里面第一个被设置为1或者0的bit位。start和end只能按字节,不能按位</li>
</ul>
...
<h4 id="redis事务本质" tabindex="-1"><a class="header-anchor" href="#redis事务本质" aria-hidden="true">#</a> Redis事务本质:</h4>
<p><u>一组命令的集合!</u></p>
...
<h4 id="redis事务操作过程" tabindex="-1"><a class="header-anchor" href="#redis事务操作过程" aria-hidden="true">#</a> Redis事务操作过程</h4>
<ul>
<li>开启事务（multi）</li>
<li>命令入队</li>
<li>执行事务（exec）</li>
...
<h4 id="正常执行" tabindex="-1"><a class="header-anchor" href="#正常执行" aria-hidden="true">#</a> 正常执行</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="取消事务-discurd" tabindex="-1"><a class="header-anchor" href="#取消事务-discurd" aria-hidden="true">#</a> 取消事务(discurd)</h4>
...
所以说<strong>Redis单条指令保证原子性，但是Redis事务不能保证原子性。</strong></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>回到线程1，执行事务：</p>
...
<span class="token string">"0"</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>解锁获取最新值，然后再加锁进行事务。</p>
<p>unwatch进行解锁。</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>输出PONG</p>
<h3 id="常用的api" tabindex="-1"><a class="header-anchor" href="#常用的api" aria-hidden="true">#</a> 常用的API</h3>
<p>string、list、set、hash、zset</p>
<p><strong>所有的api命令，就是我们对应的上面学习的指令，一个都没有变化！</strong></p>
<div class="language-JAVA ext-JAVA line-numbers-mode"><pre v-pre class="language-JAVA"><code>public class TestTX {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="springboot整合" tabindex="-1"><a class="header-anchor" href="#springboot整合" aria-hidden="true">#</a> SpringBoot整合</h2>
<p>SpringBoot 操作数据：spring-data jpa jdbc mongodb redis！</p>
<p>SpringData 也是和 SpringBoot 齐名的项目！</p>
<blockquote>
<p><strong>说明： 在 SpringBoot2.x 之后，原来使用的jedis 被替换为了 lettuce</strong></p>
</blockquote>
...
<span class="token keyword">public</span> <span class="token class-name">StringRedisTemplate</span> <span class="token function">stringRedisTemplate</span><span class="token punctuation">(</span><span class="token class-name">RedisConnectionFactory</span> redisConnectionFactory<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">UnknownHostException</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">return</span> template<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="整合测试" tabindex="-1"><a class="header-anchor" href="#整合测试" aria-hidden="true">#</a> 整合测试</h4>
<h5 id="_1-导入依赖" tabindex="-1"><a class="header-anchor" href="#_1-导入依赖" aria-hidden="true">#</a> 1.导入依赖</h5>
...
<p><img src="/images/2020-11-18-08-43-54.png" alt=""></p>
<p>那么就一定还存在一个RedisProperties类</p>
<p><img src="/images/2020-11-18-08-44-45.png" alt=""></p>
<p>@ConditionalOnClass注解中有两个类是默认不存在的，所以Jedis是无法生效的</p>
<p>然后再看Lettuce：</p>
<p><img src="/images/2020-11-18-08-45-18.png" alt=""></p>
<p>完美生效。</p>
<p>现在我们回到RedisAutoConfiguratio</p>
<p><img src="/images/2020-11-18-08-45-50.png" alt=""></p>
<p>只有两个简单的Bean</p>
<ul>
<li>RedisTemplate</li>
...
<p><img src="/images/2020-11-18-08-46-16.png" alt=""></p>
<p>这是一些基本的配置属性。</p>
<p><img src="/images/2020-11-18-08-46-43.png" alt=""></p>
<p>还有一些连接池相关的配置。注意使用时一定使用<strong>Lettuce</strong>的连接池。</p>
<p><img src="/images/2020-11-18-08-47-13.png" alt=""></p>
<h5 id="_2-编写配置文件" tabindex="-1"><a class="header-anchor" href="#_2-编写配置文件" aria-hidden="true">#</a> 2.编写配置文件</h5>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_3-使用redistemplate" tabindex="-1"><a class="header-anchor" href="#_3-使用redistemplate" aria-hidden="true">#</a> 3.使用RedisTemplate</h5>
...
<p>在企业中,大部分情况下不会使用这种原声带方式去编写代码.而是<strong>用RedisUtils去封装</strong></p>
</blockquote>
<h5 id="_4-测试结果" tabindex="-1"><a class="header-anchor" href="#_4-测试结果" aria-hidden="true">#</a> 4.测试结果</h5>
<p>此时我们回到Redis查看数据时候，惊奇发现全是乱码，可是程序中可以正常输出。这时候就关系到存储对象的序列化问题，在网络中传输的对象也是一样需要序列化，否者就全是乱码。</p>
<p>RedisTemplate内部的序列化配置是这样的</p>
<p><img src="/images/2020-11-18-08-49-50.png" alt=""></p>
<p>默认的序列化器是采用JDK序列化器</p>
<p><img src="/images/2020-11-18-08-53-34.png" alt=""></p>
<p>后续我们定制RedisTemplate就可以对其进行修改。</p>
<p>RedisSerializer提供了多种序列化方案：</p>
<p><img src="/images/2020-11-18-08-58-09.png" alt=""></p>
<p>我们来编写一个自己的 :</p>
<h4 id="redistemplete" tabindex="-1"><a class="header-anchor" href="#redistemplete" aria-hidden="true">#</a> RedisTemplete</h4>
...
<span class="token keyword">return</span> template<span class="token punctuation">;</span>
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>所有的redis操作，其实对于java开发人员来说，十分的简单，更重要是要去理解redis的思想和每一种数据结构的用处和作用场景！</p>
<h2 id="redis-conf" tabindex="-1"><a class="header-anchor" href="#redis-conf" aria-hidden="true">#</a> Redis.conf</h2>
<p>容量单位不区分大小写，G和GB有区别</p>
<p><img src="/images/2020-11-18-09-09-05.png" alt=""></p>
<ol>
<li>配置文件unit单位对大小写不敏感!</li>
<li>可以使用 include 组合多个配置问题</li>
</ol>
<p><img src="/images/2020-11-18-10-33-32.png" alt=""></p>
<h3 id="网络配置" tabindex="-1"><a class="header-anchor" href="#网络配置" aria-hidden="true">#</a> 网络配置</h3>
<div class="language-BASH ext-BASH line-numbers-mode"><pre v-pre class="language-BASH"><code>bind 127.0.0.1 # 绑定的ip
protected-mode yes #保护模式
port 6379 #端口设置
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="/images/2020-11-18-10-38-00.png" alt=""></p>
<h3 id="通用-general" tabindex="-1"><a class="header-anchor" href="#通用-general" aria-hidden="true">#</a> 通用 GENERAL</h3>
<div class="language-BASH ext-BASH line-numbers-mode"><pre v-pre class="language-BASH"><code>daemonize yes #以守护进程的方式运行,默认是默认关闭,需要开启!
pidfile /var/run/redis-6379pid #如果以后台的方式运行,我们就需要指定一个pid文件
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="日志" tabindex="-1"><a class="header-anchor" href="#日志" aria-hidden="true">#</a> 日志</h3>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 日志</span>
...
<p><strong>持久化</strong>,在规定的时间内,执行了多少次操作,则会持久化到文件 .rdb .aof</p>
<p>redis是内存数据库,<strong>如果没有持久化,那么数据断电及失!</strong></p>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 如果900s内，如果至少有一个1 key进行了修改，我们及进行持久化操作</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="security-安全" tabindex="-1"><a class="header-anchor" href="#security-安全" aria-hidden="true">#</a> SECURITY 安全</h3>
<p>可以在这里设置redis的密码，默认是没有密码！</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token number">127.0</span>.0.1:637<span class="token operator"><span class="token file-descriptor important">9</span>></span> <span class="token function">ping</span>
PONG
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>maxclients <span class="token number">10000</span> <span class="token comment"># 设置能连接上redis的最大客户端的数量</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="append-only-模式-aof配置" tabindex="-1"><a class="header-anchor" href="#append-only-模式-aof配置" aria-hidden="true">#</a> APPEND ONLY 模式 aof配置</h3>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>appendonly no <span class="token comment"># 默认是不开启aof模式的，默认是使用rdb方式持久化的，在大部分所有的情况下，rdb完全够用！</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="redis持久化" tabindex="-1"><a class="header-anchor" href="#redis持久化" aria-hidden="true">#</a> Redis持久化</h2>
<blockquote>
<p>面试和工作，持久化都是重点！</p>
</blockquote>
...
<p><img src="/images/2020-11-18-15-55-42.png" alt=""></p>
<blockquote>
<p>在指定时间间隔后，将内存中的数据集快照写入数据库 ；</p>
<p>在恢复时候，直接读取快照文件，进行数据的恢复 ；</p>
...
<p>Redis会单独创建（fork）一个子进程来进行持久化，会先将数据写入到一个临时文件中，待持久化过程都结束了，再用这个临时文件替换上次持久化好的文件。整个过程中，主进程是不进行任何IO操作的。</p>
<p>这就确保了极高的性能。如果需要进行大规模数据的恢复，且对于数据恢复的完整性不是非常敏感，那RDB方式要比AOF方式更加的高效。RDB的缺点是最后一次持久化后的数据可能丢失。我们默认的就是RDB，一般情况下不需要修改这个配置！ 有时候在生产环境我们会将这个文件进行备份！
...
<p><img src="/images/2020-11-18-16-15-11.png" alt=""></p>
...
<p>备份会自动生成一个dump.rdb</p>
<p><img src="/images/2020-11-18-16-16-54.png" alt=""></p>
<h4 id="save" tabindex="-1"><a class="header-anchor" href="#save" aria-hidden="true">#</a> save</h4>
<p>使用 save 命令，会立刻对当前内存中的数据进行持久化 ,但是会阻塞，也就是不接受其他操作了；</p>
<blockquote>
<p>由于 save 命令是同步命令，会占用Redis的主进程。若Redis数据非常多时，save命令执行速度会非常慢，阻塞所有客户端的请求。</p>
</blockquote>
<p>示意图</p>
<p><img src="/images/2020-11-18-16-37-01.png" alt=""></p>
<h4 id="flushall命令" tabindex="-1"><a class="header-anchor" href="#flushall命令" aria-hidden="true">#</a> flushall命令</h4>
<p>flushall 命令也会触发持久化 ；</p>
<p>触发持久化规则
满足配置条件中的触发条件 ；</p>
<blockquote>
<p>可以通过配置文件对 Redis 进行设置， 让它在“ N 秒内数据集至少有 M 个改动”这一条件被满足时， 自动进行数据集保存操作。</p>
</blockquote>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 持久化规则, 持久化到文件 .db .aof</span>
<span class="token comment"># 如果了900秒内至少1个key进行了修改,就进行持久化</span>
save <span class="token number">900</span> <span class="token number">1</span>
<span class="token comment"># 300秒内10个key进行了修改</span>
save <span class="token number">300</span> <span class="token number">10</span>
save <span class="token number">60</span> <span class="token number">10000</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="/images/2020-11-18-16-38-37.png" alt=""></p>
<h4 id="bgsave" tabindex="-1"><a class="header-anchor" href="#bgsave" aria-hidden="true">#</a> bgsave</h4>
<p>bgsave 是异步进行，进行持久化的时候，redis 还可以将继续响应客户端请求 ；</p>
<p><img src="/images/2020-11-18-16-42-59.png" alt=""></p>
<h4 id="bgsave和save对比" tabindex="-1"><a class="header-anchor" href="#bgsave和save对比" aria-hidden="true">#</a> bgsave和save对比</h4>
<table>
<thead>
<tr>
...
<td style="text-align:left">是（阻塞发生在fock()，通常非常快）</td>
</tr>
<tr>
...
<td style="text-align:left">不会消耗额外的内存</td>
<td style="text-align:left">不阻塞客户端命令</td>
</tr>
<tr>
<td style="text-align:left">缺点</td>
<td style="text-align:left">阻塞客户端命令</td>
<td style="text-align:left">需要fock子进程，消耗内存</td>
</tr>
</tbody>
</table>
<h4 id="恢复机制" tabindex="-1"><a class="header-anchor" href="#恢复机制" aria-hidden="true">#</a> 恢复机制</h4>
<ol>
<li>
<p>只需要将rdb文件放置我们redis的启动目录即可,redis启动时会自动检查dump.rdb文件,恢复其中的数据</p>
</li>
<li>
<p>查看需要存放的位置</p>
...
<p><img src="/images/2020-11-18-17-50-09.png" alt=""></p>
<p>以日志的形式来记录每个写的操作，将Redis执行过的所有指令记录下来（读操作不记录），只许追加文件但不可以改写文件，redis启动之初会读取该文件重新构建数据，换言之，redis重启的话就根据日志文件的内容<strong>将写指令从前到后执行一次</strong>以完成数据的恢复工作。</p>
<blockquote>
<p>Aof保存的是 appendonly.aof文件</p>
</blockquote>
<h4 id="什么是aof" tabindex="-1"><a class="header-anchor" href="#什么是aof" aria-hidden="true">#</a> 什么是AOF</h4>
<p>快照功能（RDB）并不是非常耐久（durable）： 如果 Redis 因为某些原因而造成故障停机， 那么服务器将丢失最近写入、以及未保存到快照中的那些数据。 从 1.1 版本开始， Redis 增加了一种完全耐久的持久化方式： AOF 持久化。</p>
<p><img src="/images/2020-11-18-18-07-45.png" alt=""></p>
<p>appendonly no yes则表示启用AOF</p>
<p>默认是不开启的，我们需要手动配置，然后重启redis，就可以生效了！</p>
<p><strong>记录的文件为</strong><code v-pre>appendonly.aof</code></p>
<p>如果这个aof文件有错位，这时候redis是启动不起来的，我需要修改这个aof文件</p>
<p>redis给我们提供了一个工具redis-check-aof --fix</p>
<p><img src="/images/2020-11-18-18-21-58.png" alt=""></p>
<p>如果文件正常了,重启就可以恢复了</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="重写规则" tabindex="-1"><a class="header-anchor" href="#重写规则" aria-hidden="true">#</a> 重写规则</h4>
<blockquote>
<p>aof默认就是文件的无限追加,文件会越来越大!</p>
</blockquote>
<p><img src="/images/2020-11-18-18-25-55.png" alt=""></p>
<p>如果aof文件大于64MB,fork一个新的进程来将我们的文件进行重写!</p>
...
<ul>
<li>因为RDB文件只用作后备用途，建议只在Slave上持久化RDB文件，而且只要15分钟备份一次就够了，<strong>只保留 save 900 1</strong> 这条规则。</li>
...
<p>Redis 发布订阅(pub/sub)是一种消息通信模式：</p>
<p>发送者(pub)发送消息，订阅者(sub)接收消息。</p>
<p>微信、 微博、关注系统！</p>
<p>Redis 客户端可以订阅任意数量的频道。</p>
<p>订阅/发布消息图：
<img src="/images/2020-11-18-18-32-35.png" alt="">
第一个：消息发送者</p>
<p>第二个：频道</p>
<p>第三个：消息订阅者</p>
<p>下图展示了频道 channel1 ， 以及订阅这个频道的三个客户端 —— client2 、 client5 和 client1 之间的关系：</p>
<p><img src="/images/2020-11-18-18-33-26.png" alt=""></p>
<p>当有新消息通过 PUBLISH 命令发送给频道 channel1 时， 这个消息就会被发送给订阅它的三个客户端：</p>
<p><img src="/images/2020-11-18-18-35-49.png" alt=""></p>
<h3 id="命令" tabindex="-1"><a class="header-anchor" href="#命令" aria-hidden="true">#</a> 命令</h3>
<ul>
<li><code v-pre>PSUBSCRIBE pattern [pattern..]</code> 订阅一个或多个符合给定模式的频道。</li>
<li><code v-pre>PUNSUBSCRIBE pattern [pattern..]</code> 退订一个或多个符合给定模式的频道。</li>
<li><code v-pre>PUBSUB subcommand [argument[argument]]</code> 查看订阅与发布系统状态。</li>
<li><code v-pre>PUBLISH channel message</code> 向指定频道发布消息</li>
<li><code v-pre>SUBSCRIBE channel [channel..]</code> 订阅给定的一个或多个频道。</li>
<li><code v-pre>UNSUBSCRIBE channel [channel..]</code> 退订一个或多个频道</li>
</ul>
<h3 id="代码示例-2" tabindex="-1"><a class="header-anchor" href="#代码示例-2" aria-hidden="true">#</a> 代码示例</h3>
...
<span class="token string">"shane"</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="原理" tabindex="-1"><a class="header-anchor" href="#原理" aria-hidden="true">#</a> 原理</h3>
...
<p><img src="/images/2020-11-18-18-45-34.png" alt=""></p>
...
<p>主从复制，是指将一台Redis服务器的数据，复制到其他的Redis服务器。前者称为主节点（Master/Leader）,后者称为从节点（Slave/Follower）， 数据的复制是单向的！只能由主节点复制到从节点（<u>主节点以写为主、从节点以读为主</u>）。</p>
...
<ol>
<li>
<p>从结构上，单个Redis服务器会发生单点故障，并且一台服务器需要处理所有的请求负载，压力较大；</p>
</li>
<li>
<p>从容量上，单个Redis服务器内存容量有限，就算一台Redis服务器内存容量为256G，也不能将所有内存用作Redis存储内存，一般来说，单台Redis最大使用内存不应该超过20G。</p>
</li>
</ol>
<p>电商网站上的商品，一般都是一次上传，无数次浏览的，说专业点也就是&quot;多读少写&quot;。</p>
<p>对于这种场景，我们可以使如下这种架构：</p>
<p><img src="/images/2020-11-18-18-47-22.png" alt=""></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>复制3个配置文件，然后修改对应的信息</p>
<ol>
<li>端口</li>
<li>pid名字</li>
<li>log文件名</li>
<li>dump.rdb名字</li>
<li>修改完毕之后,启动我们的三个redis服务器,可通过进程信息查看!</li>
</ol>
<p>启动单机多服务集群：</p>
<p><img src="/images/2020-11-18-22-24-43.png" alt=""></p>
...
<p><img src="/images/2020-11-18-22-27-51.png" alt=""></p>
<p><strong>说明</strong></p>
<ul>
<li><code v-pre>SLAVEOF host 6379</code> 找谁当自己的老大！</li>
<li><code v-pre>role:slave</code> # 当前角色是从机</li>
<li><code v-pre>master_host:127.0.0.1</code> # 可以的看到主机的信息</li>
</ul>
<p>然后主机上也能看到从机的状态：</p>
<p><img src="/images/2020-11-18-22-31-28.png" alt=""></p>
<p><strong>说明</strong></p>
<ul>
<li><code v-pre>connected_slaves:1</code> # 多了从机的配置</li>
<li><code v-pre>slave0:ip=127.0.0.1,port=6380,state=online,offset=42,lag=1</code> # 多了从机的配置</li>
</ul>
<p>真实的从主配置应该在配置文件中配置，这样的话是永久的，我们这里使用的是命令，暂时的！</p>
<h4 id="使用规则" tabindex="-1"><a class="header-anchor" href="#使用规则" aria-hidden="true">#</a> 使用规则</h4>
<ol>
...
<p>如果主机断开了连接，我们可以使用<code v-pre>SLAVEOF no one</code>让自己变成主机！其他的节点就可以手动连接到最新的主节点（手动）！如果这个时候老大修复了，那么就重新连接！</p>
...
<h3 id="层层链路" tabindex="-1"><a class="header-anchor" href="#层层链路" aria-hidden="true">#</a> 层层链路</h3>
<p>上一个M链接下一个S,下一个从机的主机一直是上一个节点.</p>
<p>此时只有第一个节点为主机,它的数据会同步给之后的所有从机(之后的节点都会作为从机)</p>
<blockquote>
<p>主机断了可以使用<code v-pre>SLAVEOF no one</code>使自己变为主机!其他节点就需要手动连接到这个主节点</p>
</blockquote>
...
<p>主从切换技术的方法是：当主服务器宕机后，需要手动把一台从服务器切换为主服务器，这就需要人工干预，费事费力，还会造成一段时间内服务不可用。这不是一种推荐的方式，更多时候，我们优先考虑哨兵模式。Redis从2.8开始正式提供了Sentinel（哨兵） 架构来解决这个问题。<strong>能够后台监控主机是否故障，如果故障了根据投票数自动将从库转换为主库。</strong></p>
<p>哨兵模式是一种特殊的模式，首先Redis提供了哨兵的命令，哨兵是一个独立的进程，作为进程，它会独立运行。其原理是哨兵通过发送命令，等待Redis服务器响应，从而监控运行的多个Redis实例。</p>
<p><img src="/images/2020-11-19-08-51-39.png" alt=""></p>
<p>哨兵的作用：</p>
<ul>
...
<p><img src="/images/2020-11-19-08-52-49.png" alt=""></p>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># sentinel monitor 被监控的名称 host port 1</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>后面的这个数字1，代表主机挂了，slave投票看让谁接替成为主机，票数最多的，就会成为主机！</p>
<ol start="2">
<li>启动哨兵！</li>
</ol>
<p><img src="/images/2020-11-19-08-55-58.png" alt=""></p>
<ol start="3">
<li>此时哨兵监视着我们的主机6379，当我们断开主机后：</li>
</ol>
<p><img src="/images/2020-11-19-08-56-37.png" alt=""></p>
<h2 id="哨兵模式优缺点" tabindex="-1"><a class="header-anchor" href="#哨兵模式优缺点" aria-hidden="true">#</a> 哨兵模式优缺点</h2>
<p>优点：</p>
<ol>
...
<h2 id="哨兵模式的全部配置" tabindex="-1"><a class="header-anchor" href="#哨兵模式的全部配置" aria-hidden="true">#</a> 哨兵模式的全部配置</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="缓存穿透与雪崩" tabindex="-1"><a class="header-anchor" href="#缓存穿透与雪崩" aria-hidden="true">#</a> 缓存穿透与雪崩</h2>
...
<p><img src="/images/2020-11-19-10-10-08.png" alt=""></p>
...
<p><img src="/images/2020-11-19-10-11-08.png" alt=""></p>
...
<p><img src="/images/2020-11-19-10-11-58.png" alt=""></p>
...
<p><img src="/images/2020-11-19-10-16-16.png" alt=""></p>
...
<p><img src="/images/2020-11-19-10-17-48.png" alt=""></p>
...
<h4 id="redis高可用" tabindex="-1"><a class="header-anchor" href="#redis高可用" aria-hidden="true">#</a> redis高可用</h4>
