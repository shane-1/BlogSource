<template><div><h1 id="注解和反射" tabindex="-1"><a class="header-anchor" href="#注解和反射" aria-hidden="true">#</a> 注解和反射</h1>
<h1 id="annotation-and-reflection" tabindex="-1"><a class="header-anchor" href="#annotation-and-reflection" aria-hidden="true">#</a> Annotation and Reflection</h1>
<blockquote>
<p>框架实现基础</p>
</blockquote>
...
<h3 id="annotation在哪里使用" tabindex="-1"><a class="header-anchor" href="#annotation在哪里使用" aria-hidden="true">#</a> Annotation在哪里使用?</h3>
<ul>
...
<h3 id="内置注解" tabindex="-1"><a class="header-anchor" href="#内置注解" aria-hidden="true">#</a> 内置注解</h3>
<ul>
<li>@override :定义在java.lang.Override中,此注释只适用于修辞方法,表示一个方法声明打算重写超类中的另一个方法声明.</li>
<li>@Deprecated :定义在java.lang.Deprecated中,此注释可以用于修辞<code v-pre>方法</code>,<code v-pre>属性</code>,<code v-pre>类</code>,表示不鼓励程序员使用这样的元素,通常是因为它很危险或者存在更好的选择.</li>
<li>@SuppressWarnings :定义在java.lang.SuppressWarnings中,用来抑制编译时的警告信息.
<ul>
...
<li>这些类型和它们所支持的类在java.lang.annotation包中可以找到.(@Target , @Retention@Documented , @lnherited)
<ul>
...
<ul>
<li>使用@interface自定义注解时,自动继承了java.lang.annotatlon.Annotation接口
<ul>
<li>分析:
<ul>
...
<li>如果只有一个参数成员,一般参数名为value/注解元素必须要有值,我们定义注解元素时,经常使用空字符串,0作为默认值.</li>
</ul>
</li>
</ul>
</li>
...
<p>如果自定义注解只有一个值时，建议设置为value，此时在注解传递参数可省略名字</p>
</blockquote>
<h2 id="反射" tabindex="-1"><a class="header-anchor" href="#反射" aria-hidden="true">#</a> 反射</h2>
<blockquote>
<p>基于 JDK 1.8</p>
</blockquote>
<h3 id="回顾-什么是反射" tabindex="-1"><a class="header-anchor" href="#回顾-什么是反射" aria-hidden="true">#</a> 回顾：什么是反射？</h3>
<p><strong>反射 (Reflection) 是 Java 的特征之一，它允许运行中的 Java 程序获取自身的信息，并且可以操作类或对象的内部属性。</strong><br></p>
<p>Oracle 官方对反射的解释是：<br></p>
<blockquote>
...
<p>  Reflection (反射)是Java被视为动态语言的关键,反射机制允许程序在执行期借助于Reflection API取得任何类的内部信息,并能直接操作任意对象的内部属性及方法<br>
<code v-pre>Class c = Class.forName(&quot;java.lang.String&quot;)</code><br>
  加载完类之后,在堆内存的方法区中就产生了一个Class类型的对象(一个类只有个Class对象,这个对象就包含了完整的类的结构信息 我们可以通过这个对象看到类的结构。这个对象就像一面镜子,透过这个镜子看到类的结构,所以我们形象的称之为:反射<br></p>
...
<li>Java不是动态语言,但Java可以称之为准动态语言&quot;)即Java有一定的动态性,我们可以利用反射机制获得类似动态语言的特性。Java的动态性让编程的时候更加灵活!</li>
</ul>
<p>Java 反射主要提供以下功能：</p>
<ul>
...
<li>在运行时调用任意一个对象的方法<br></li>
</ul>
<p>重点：<strong>是运行时而不是编译时</strong></p>
<h3 id="反射的主要用途" tabindex="-1"><a class="header-anchor" href="#反射的主要用途" aria-hidden="true">#</a> 反射的主要用途</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>  配置文件与 Action 建立了一种映射关系，当 View 层发出请求时，请求会被 <code v-pre>StrutsPrepareAndExecuteFilter</code> 拦截，然后 <code v-pre>StrutsPrepareAndExecuteFilter</code> 会去动态地创建 Action 实例。比如我们请求 <code v-pre>login.action</code>，那么 <code v-pre>StrutsPrepareAndExecuteFilter</code>就会去解析struts.xml文件，检索action中name为login的Action，并根据class属性创建SimpleLoginAction实例，并用invoke方法来调用execute方法，这个过程离不开反射。</p>
<p>  对与框架开发人员来说，反射虽小但作用非常大，它是各种容器实现的核心。而对于一般的开发者来说，不深入框架开发则用反射用的就会少一点，不过了解一下框架的底层机制有助于丰富自己的编程思想，也是很有益的。</p>
<h3 id="反射的基本运用" tabindex="-1"><a class="header-anchor" href="#反射的基本运用" aria-hidden="true">#</a> 反射的基本运用</h3>
<p>上面我们提到了反射可以用于判断任意对象所属的类，获得 Class 对象，构造任意一个对象以及调用一个对象。这里我们介绍一下基本反射功能的使用和实现(反射相关的类一般都在 java.lang.relfect 包里)。</p>
...
<h3 id="class类-反射的源头" tabindex="-1"><a class="header-anchor" href="#class类-反射的源头" aria-hidden="true">#</a> Class类（反射的源头）</h3>
<p>  对象照镜子后可以到的信息:某个类的属性、方法和构造器、某个类到底实现了哪些接口。对于每个类而言, RE都为其保留一个不变的class类型的对象。一个Class对象包含了特定某个结构(class/interface/enum/annotation/primitive type/void/)的有关信息。</p>
<ul>
<li>Class本身也是一个类Class对象只能由系统建立对象</li>
...
<h3 id="类加载内存分享" tabindex="-1"><a class="header-anchor" href="#类加载内存分享" aria-hidden="true">#</a> 类加载内存分享</h3>
<p><img src="/images/2020-09-16-16-26-06.png" alt=""></p>
<p>初始化过程：
<img src="/images/2020-09-17-09-15-19.png" alt=""></p>
<ul>
...
<h3 id="分析类初始化" tabindex="-1"><a class="header-anchor" href="#分析类初始化" aria-hidden="true">#</a> 分析类初始化</h3>
<ul>
<li>类的主动引用(一定会发生类的初始化)
<ul>
<li>当虚拟机启动, 初始化main方法所在的类</li>
<li>new一个类的对象</li>
...
<li>类的被动引用(不会发生类的初始化)
<ul>
<li>当访问一个静态域时,只有真正声明这个域的类才会被初始化。如:当通过子类引用父类的静态变量,不会导致子类初始</li>
...
<h4 id="加载器分类" tabindex="-1"><a class="header-anchor" href="#加载器分类" aria-hidden="true">#</a> 加载器分类</h4>
<blockquote>
<p>引导类&gt;扩展类&gt;系统类</p>
</blockquote>
<ul>
<li>引导类加载器 Bootstap ClassLoader:</li>
</ul>
<p>  用C++编写的,是JVM自带的类加载器,负责Java平台核心库,用来装载核心类库。该加载器无法直接获取</p>
<ul>
<li>扩展类加载器 Extension Classloader:</li>
</ul>
<p>  负责jrelib/ext目录下的jar包或D java.ext.dirs指定目录下的jar包装入工作库</p>
<ul>
<li>系统类加载器 System Classloader:</li>
</ul>
<p>  负责java-classpath或-Djava.class.path所指的目录下的类与jar包装入工作,是最常用的加载器</p>
...
<blockquote>
<p>sun.misc. Launcher$App lassLoader@18b4aac2<br>
sun.misc. Launcher$ExtclassLoader@4554617c <br>
null<br>
sun.misc. LauncherşAppClassLoadera18b4aac2 <br>
null<br><br>
Process finished with exit code o</p>
</blockquote>
<h3 id="获得-class-对象" tabindex="-1"><a class="header-anchor" href="#获得-class-对象" aria-hidden="true">#</a> 获得 Class 对象</h3>
<ul>
<li>若已知具体的类,通过类的class属性获取,该方法最为安全可靠,程序性能最高。<br>
<code v-pre>Class clazz = Person.class;</code></li>
<li>已知某个类的实例,调用该实例的getClass()方法获取Class对象<br>
<code v-pre>Class clazz = person.getClass();</code></li>
<li>已知一个类的全类名,且该类在类路径下,可通过Class类的静态方法forName()获取,可能抛出ClassNotFoundException<br>
<code v-pre>Class clazz = Class.forName(&quot;demo01.Student&quot;);</code></li>
...
<h3 id="判断是否为某个类的实例" tabindex="-1"><a class="header-anchor" href="#判断是否为某个类的实例" aria-hidden="true">#</a> 判断是否为某个类的实例</h3>
<p>  一般地，我们用 instanceof 关键字来判断是否为某个类的实例。同时我们也可以借助反射中 Class 对象的 isInstance() 方法来判断是否为某个类的实例，它是一个 native 方法：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="创建实例" tabindex="-1"><a class="header-anchor" href="#创建实例" aria-hidden="true">#</a> 创建实例</h3>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">//获取String所对应的Class对象</span>
<span class="token class-name">Class</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token operator">?</span><span class="token punctuation">></span></span> c <span class="token operator">=</span> <span class="token class-name">String</span><span class="token punctuation">.</span><span class="token keyword">class</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="获取方法" tabindex="-1"><a class="header-anchor" href="#获取方法" aria-hidden="true">#</a> 获取方法</h3>
<p>获取某个Class对象的方法集合，主要有以下几个方法：</p>
<p>  getDeclaredMethods 方法返回类或接口声明的所有方法，包括公共、保护、默认（包）访问和私有方法，但<em>不包括继承的方法</em>。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>  getMethods 方法返回某个类的所有公用（public）方法，<em>包括其继承类的公用方法</em>。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>  getMethod 方法返回一个特定的方法，其中第一个参数为方法名称，后面的参数为方法的参数<em>对应Class的对象</em>。(因为重载需要定位)</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>只是这样描述的话可能难以理解，我们用例子来理解这三个方法：</p>
...
<span class="token keyword">class</span> methodClass <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>程序运行的结果如下:</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>getMethods获取的方法：
...
public int org.ScZyhSoft.common.methodClass.add(int,int)
public int org.ScZyhSoft.common.methodClass.sub(int,int)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>  可以看到，通过 getMethods() 获取的方法可以获取到父类的方法,比如 java.lang.Object 下定义的各个方法。</p>
<h3 id="获取构造器信息" tabindex="-1"><a class="header-anchor" href="#获取构造器信息" aria-hidden="true">#</a> 获取构造器信息</h3>
<p>  获取类构造器的用法与上述获取方法的用法类似。主要是通过Class类的getConstructor方法得到Constructor类的一个实例，而Constructor类有一个newInstance方法可以创建一个对象实例:</p>
<blockquote>
<p>使用getDeclaredConstructors可以获得所有构造器</p>
</blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>此方法可以根据传入的参数来调用对应的Constructor创建对象实例。</p>
<h3 id="获取类的成员变量-字段-信息" tabindex="-1"><a class="header-anchor" href="#获取类的成员变量-字段-信息" aria-hidden="true">#</a> 获取类的成员变量（字段）信息</h3>
<p>主要是这几个方法，在此不再赘述：<br></p>
<ul>
<li><code v-pre>getFiled：</code>访问<em>公有</em>的成员变量</li>
<li><code v-pre>getDeclaredField：</code>所有已声明的成员变量，但不能得到其父类的成员变量</li>
</ul>
<blockquote>
<p><code v-pre>getFileds</code> 和 <code v-pre>getDeclaredFields</code> 方法用法同上（参照 Method）。</p>
</blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>下面是一个实例：</p>
...
<span class="token keyword">class</span> methodClass <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>Object invoke (Object obj, Object ... args)</code></p>
<ul>
<li>Object对应原方法的返回值,若原方法无返回值,此时返回null</li>
<li>若原方法若为静态方法,此时形参Object obj可为null</li>
<li>若原方法形参列表为空,则ObjectI] args为null</li>
<li>若原方法声明为private,则需要在调用此invoke()方法前,显式调用方法对象的setAccessible(true)方法,将可访问private的方法。</li>
</ul>
<h3 id="动态创建对象" tabindex="-1"><a class="header-anchor" href="#动态创建对象" aria-hidden="true">#</a> 动态创建对象</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> dynamicObjects<span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="setaccessible" tabindex="-1"><a class="header-anchor" href="#setaccessible" aria-hidden="true">#</a> setAccessible</h3>
<ul>
<li>Method和Field,Constructor对象都有setAccessible()方法。</li>
<li>setAccessible作用是启动和禁用访问安全检查的开关。</li>
<li>参数值为true则指杀反射的对象在使用时应该取消Java语言访问检查。
<ul>
...
<h3 id="利用反射创建数组" tabindex="-1"><a class="header-anchor" href="#利用反射创建数组" aria-hidden="true">#</a> 利用反射创建数组</h3>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">testArray</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ClassNotFoundException</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>  其中的Array类为java.lang.reflect.Array类。我们通过<code v-pre>Array.newInstance()</code>创建数组对象，它的原型是:</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token class-name">Object</span> <span class="token function">newInstance</span><span class="token punctuation">(</span><span class="token class-name">Class</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token operator">?</span><span class="token punctuation">></span></span> componentType<span class="token punctuation">,</span> <span class="token keyword">int</span> length<span class="token punctuation">)</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>  而 <code v-pre>newArray </code>方法是一个 native 方法，它在 HotSpot JVM 里的具体实现我们后边再研究，这里先把源码贴出来：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">private</span> <span class="token keyword">static</span> <span class="token keyword">native</span> <span class="token class-name">Object</span> <span class="token function">newArray</span><span class="token punctuation">(</span><span class="token class-name">Class</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token operator">?</span><span class="token punctuation">></span></span> componentType<span class="token punctuation">,</span> <span class="token keyword">int</span> length<span class="token punctuation">)</span>
        <span class="token keyword">throws</span> <span class="token class-name">NegativeArraySizeException</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>源码目录：<code v-pre>openjdk\hotspot\src\share\vm\runtime\reflection.cpp</code></p>
<div class="language-cpp ext-cpp line-numbers-mode"><pre v-pre class="language-cpp"><code>arrayOop <span class="token class-name">Reflection</span><span class="token double-colon punctuation">::</span><span class="token function">reflect_new_array</span><span class="token punctuation">(</span>oop element_mirror<span class="token punctuation">,</span> jint length<span class="token punctuation">,</span> TRAPS<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>  另外，Array 类的 <code v-pre>set</code> 和 <code v-pre>get </code>方法都为 native 方法，在 HotSpot JVM 里分别对应<code v-pre> Reflection::array_set</code> 和 <code v-pre>Reflection::array_get</code> 方法，这里就不详细解析了。</p>
<h3 id="反射过程" tabindex="-1"><a class="header-anchor" href="#反射过程" aria-hidden="true">#</a> 反射过程</h3>
<p>java.lang.Class是反射的源头</p>
<ol>
<li>我们创建了一个类,通过编译(javac.exe)生成了字节码文件.class文件.</li>
<li>此.class文件加载到内存中去以后,就是一个运行时类,存在缓存区,那么这个运行时类本身就是Class的实例.</li>
<li>每个运行时类只加载一次</li>
<li>有了Class的实例后,我们可以做如下操作:
<ul>
<li>创建对应的<strong>运行时</strong>类的对象</li>
<li>获取对应的<strong>运行时</strong>类的属性,方法,构造方法,父类,所在的包,异常,接口等</li>
<li>调用对应的<strong>运行时</strong>类的属性,方法,构造方法等</li>
</ul>
</li>
</ol>
<h3 id="性能分析" tabindex="-1"><a class="header-anchor" href="#性能分析" aria-hidden="true">#</a> 性能分析</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">//分析性能问题</span>
...
<blockquote>
<p>普通方式执行10亿次:9ms<br>反射方式执行10亿次:5699ms<br>关闭检测执行10亿次: 1959ms</p>
</blockquote>
<h3 id="反射与泛型" tabindex="-1"><a class="header-anchor" href="#反射与泛型" aria-hidden="true">#</a> 反射与泛型</h3>
<ul>
<li>反射操作泛型Java采用泛型擦除的机制来引入泛型, Java中的泛型仅仅是给编译器javac使用的,确保数据的安全性和免去强制类型转换问题,但是,一旦编译完成,所有和泛型有关的类型全部擦除</li>
<li>为了通过反射操作这些类型, Java新增了ParameterizedType , GenericArrayTypeTypeVariable和WildcardType几种类型来代表不能被归一到Class类中的类型但是又和原始类型齐名的类型.
<ul>
<li>ParameterizedType :表示一种参数化类型,比如<code v-pre>Collection&lt;String&gt;</code></li>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Test11</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="反射与注解" tabindex="-1"><a class="header-anchor" href="#反射与注解" aria-hidden="true">#</a> 反射与注解</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> reflectionAnnotation<span class="token punctuation">{</span>
...
<p>  由于反射会额外消耗一定的系统资源，因此如果不需要动态地创建一个对象，那么就不需要用反射。</p>
<p>  另外，反射调用方法时可以忽略权限检查，因此可能会破坏封装性而导致安全问题。</p>
<h3 id="部分反射内容转载自" tabindex="-1"><a class="header-anchor" href="#部分反射内容转载自" aria-hidden="true">#</a> 部分反射内容转载自</h3>
<blockquote>
<p>本文标题:深入解析Java反射（1） - 基础<br>
文章作者:sczyh30<br>
发布时间:2015年06月24日<br>
原始链接:http://www.sczyh30.com/posts/Java/java-reflection-1/<br>
许可协议: &quot;知识共享-保持署名-非商用-相同方式共享 4.0&quot; 转载请保留原文链接及作者。</p>
</blockquote>
<hr>
<p>整理不易，转载请注明出处。
相关视频教程可参考狂神说</p>
