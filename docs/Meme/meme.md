...
过于绝对的观点都要小心，它不像是观点，更像是口号，而口号的作用不是分享一种想法，而是攻击口号的对立面。

## 2023.4.13

在虚无面前，我们毫无办法，只能于此于爱攥紧彼此。

那时，那刻，那段时间，那些爱，就是宏大宇宙无尽时间我们的存在。

## 2023.3.2

已经用了 ChatGPT 一段时间了，我一开始对其态度就是怀疑和审慎，到现在少了分怀疑，更多了分审慎。其和其代表的超大规模语言模型，对于先今以网络空间主导的社会形态影响都是长远而深刻的，我个人认为其未来走向会直接影响人类发展趋势（如此也能理解很多人第三次工业革命的论调）。
这样分析也许太过宏达叙事，我只从程序员角度分析：超大规模语言模型第一波及的必然是以语言为核心的工作，而其影响必然从简单到复杂。目前 ChatGPT 在编程主要以写代码片段为主，没有大型软件架构能力。但现在如此，未来一直如此吗？语言和逻辑本身就是此类模型擅长的核心，也许在目前的已经瓶颈靠堆砌的半导体计算机硬件跑不出，但量子计算机、生物计算机等可能的下一代计算平台呢？更大尺度看如果其能够自行迭代呢？其也具有逆熵的生命欲望呢？如果只是把 ChatGPT 为代表的以类神经网络计算模型之后的发展理解为对于文字推理的数字计算，那人类的智慧是否也会被简化到神经元放电。
也许其看起来很简陋，但在数量级显著增加后表现出一些人类难以理解的能力（如 ChatGPT 撰写论文的能力），也许下一个人类文明的奇点时刻真会发生在类神经网络计算模型。无论如何，资本已经在路上，剩下的与诸位且走且看。
...
我不同意你的观点，但我要捍卫你发表观点的权利。

## 2020.5.10

你选择歧视和偏见吧，那也不是什么你口中的选择，那 4%~8% 也不会神奇的消失，只会因为偏见而隐藏和压抑自己。也许你也会因此受害，谁又说得清呀？毕竟我们是一个整体。而互联网是个大粪坑，什么垃圾情绪都丢弃到之中，我不知道善良的感染力如何，反正仇恨感染力挺强的。
...
>我也许会跟你说，千万别结婚，除非你情不自禁，除非你为之着迷。除非你为之着迷，那才是生活的全部意义。<br>
——罗伯特·弗罗斯特
...
—— romain rolland
## 2020.4.7
#### 和自己对话的孤独是很珍贵的，很多人因害怕孤独而妥协，最终连自我都不存在，还安慰自己生活就应如此。生活没有模板，在孤独中了解你自己所想，因害怕孤独寻找 solumate 最终连 soul 都没有了，结局也只是另一种形式的孤独终老。当荷尔蒙消散，留给你的自己与对方的互相折磨，你只好安慰自己，大家都是这么活的。
## 2020.4.6
...
## 2020.3.11
>你迷茫的原因是懂了太少，想得太多，试着 focus on youself.
## 2020.3.10
...
——王小波《工作与人生》
## 2020.3.7
>我对自己的要求很低，我活在世上，无非想要明白些道理，遇见一些有趣的人，发生一些有趣的事。倘若如我所愿，还能遇见 ta，我的一生就算十分成功。
---
## 2020.3.6
...
## 2020.3.3
常见流氓逻辑：
>如果你对 XX 不满，不应该一味抱怨，应该好好学习，成为 XXer，将来改变 XX。<br>
#### 敢情好好学习是万能的，我不学习成为 XX 连抗议都不配吗？
---
## 2020.3.2
>&emsp;英国维多利亚时期、美国上个世纪 19 年代和当今中国，在对待性这个话题上竟出奇的一致。<br>
...
----
## 2020.2.28
&emsp;对于自由意志的存在性，我始终抱有怀疑，人总是或多或少接受着他人的投射，meme 总是在有意无意间影响者我们，也许一切如同历史唯物主义所说。也许只有怀疑本身，才是我们存在的基点
